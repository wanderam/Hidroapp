...
Aplicativo via web desenvolvido para exibir os resultados de fluxo de base estimados por meio da biblioteca Python *Hydrograph-py* ([Terink 2019](https://app.readthedocs.org/projects/hydrograph-py/downloads/pdf/latest/)) e de recarga de aquíferos estimada por meio do modelo SWAT-MODFLOW ([Bailey et al. 2016](https://onlinelibrary.wiley.com/doi/full/10.1002/hyp.10933)).
